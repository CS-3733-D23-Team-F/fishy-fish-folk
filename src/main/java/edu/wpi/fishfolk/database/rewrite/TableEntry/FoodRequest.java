...
public class FoodRequest {
     ...
     */
    public FoodRequest(String id, String assignee, FormStatus status, ArrayList<FoodItem> items, LocalDateTime time, CreditCardInfo payer, String location, float totalPrice) {
        this.id = id;
